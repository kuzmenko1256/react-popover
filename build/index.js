...
var Popover = function (_React$Component) {
  ...
  _createClass(Popover, [{
    ...
    value: function componentWillReceiveProps(propsNext) {
      ...
      this.targetEl = _reactDom2.default.findDOMNode(propsNext.targetAtom ? propsNext.targetAtom : this);
    ...
    value: function measureTargetBounds() {
      var newTargetBounds = _layout2.default.El.calcBounds(this.targetEl, this.props.targetAtom);
